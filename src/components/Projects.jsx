...
const Projects = () => {
  ...
  return (
    <section ref={sectionRef} id="projects" className="min-h-screen bg-light-bg overflow-hidden relative border-t border-gray-100">
      ...
      <div ref={trackRef} className="flex items-center h-screen pt-40 px-[10vw] gap-12 md:gap-20 will-change-transform">
              ...
              <div className="relative flex-1 overflow-hidden bg-gray-50">
                ...
                <div className="absolute bottom-4 right-4 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out z-10">
                  <span className="bg-white/90 backdrop-blur-md text-accent-black px-4 py-2 rounded-full font-bold text-[10px] md:text-xs uppercase tracking-widest shadow-xl flex items-center gap-2 group/btn">
                    View Source
                    <svg className="w-3 h-3 md:w-4 md:h-4 text-accent-blue transform transition-transform duration-300 group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col gap-3 md:gap-4 relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.techStack.map((tech, i) => (
                    <span key={i} className="px-2.5 py-1 text-[9px] md:text-[10px] font-bold uppercase tracking-wider rounded-md bg-accent-blue/5 text-accent-blue border border-accent-blue/10 group-hover:bg-accent-blue/10 transition-colors duration-300">
                      {tech}
                    </span>
                  ))}
                </div>
        ...
        >
          <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border border-dashed border-gray-300 flex items-center justify-center transition-all duration-700 group-hover:border-accent-blue group-hover:scale-110 group-hover:bg-accent-blue/5 relative">
            ...
            <svg className="w-10 h-10 md:w-12 md:h-12 text-gray-400 group-hover:text-accent-blue transition-colors duration-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h4 className="mt-8 text-lg md:text-xl font-bold text-text-primary group-hover:text-accent-blue transition-colors uppercase tracking-[0.3em]">Explore Github</h4>
          <p className="text-text-secondary text-xs mt-3 uppercase tracking-widest opacity-60">View all repositories</p>
        </div>
      </div>
    </section>
  );
