...
const Footer = () => {
  return (
    <footer className="py-8 px-6 bg-dark-bg border-t border-gray-800">
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {/* Right: Social Media */}
          <div>
            <h4 className="text-white font-semibold mb-3 text-center md:text-right">
              Media
            </h4>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center">
          <p className="text-gray-500 text-sm">
            © Copyright 2024. Made by <span className="text-neon-purple">Falak</span>
          </p>
        </div>
      </div>
    </footer>
