  ...
  const experiences = [
    {
      ...
      description: "Next.js , MongoDB , Rust , API Development , Full-Stack Development",
      stickyColor: "bg-[#FEF08A]",
      barColor: "bg-[#7C3AED]", // Violet/Purple bar
    ...
    },
    {
      ...
      description: "Python , SQL , Machine Learning , TensorFlow , Scikit-learn , Flask",
      stickyColor: "bg-[#FEF08A]",
      barColor: "bg-[#EC4899]", // Pink bar
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="relative group/card fade-in">
              ...
              <div className="relative bg-white border border-gray-100 p-10 pr-48 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.07)] transition-all duration-700 overflow-visible group-hover/card:translate-y-[-2px]">
                ...
                <div className="mb-6">
                  <h3 className="text-[28px] font-sans font-bold text-[#1a1a1a] tracking-tight inline-block mr-3">
                    {exp.company}
                  </h3>
                  <span className="text-gray-400 text-base font-medium">({exp.period})</span>
                </div>

                {/* Tags in a single line below */}
                ...
                {/* THE REALISTIC STICKY NOTE (Top Right) */}
                <div 
                ...
                >
                  ...
                  {/* Corner Curl Effect (Match Image) */}
        ...
        <div className="text-center mt-24">
          <a
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-accent-black text-white font-bold rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02]"
          >
            <div className="absolute inset-x-0 bottom-0 h-1 bg-white opacity-0 group-hover:opacity-10 transition-opacity"></div>
