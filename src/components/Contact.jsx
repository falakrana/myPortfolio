      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 fade-in">
          ...
          <a
            ...
            className="group bg-[#0f172a] rounded-2xl border border-accent-blue/20 p-8 hover:shadow-xl hover:shadow-accent-blue/10 hover:border-accent-blue/40 hover:-translate-y-1 transition-all duration-500"
          >
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 bg-accent-blue/10 rounded-2xl flex items-center justify-center group-hover:bg-accent-blue/20 transition-colors">
              ...
              <div>
                ...
                <p className="text-white font-bold text-lg group-hover:text-accent-blue transition-colors">ranafalak18@gmail.com</p>
              </div>
            </div>
            <p className="text-slate-300 text-sm">Drop me an email anytime. I'll get back to you as soon as possible!</p>
          </a>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <p className="text-slate-400 text-sm font-medium">Connect on</p>
                <p className="text-white font-bold text-lg group-hover:text-accent-blue transition-colors">LinkedIn</p>
              </div>
            </div>
            <p className="text-slate-300 text-sm">Let's connect professionally and grow our networks together.</p>
          </a>
        </div>
